...
ft_calloc.c ft_strjoin.c ft_strtrim.c ft_strmapi.c ft_itoa.c ft_striteri.c ft_strdup.c

BONUS_SOURCES = ft_lstadd_back.c ft_lstadd_front.c ft_lstclear.c ft_lstdelone.c ft_lstiter.c \
